...
#else
#define PDC_FONT_PATH "FiraCode.ttf"
#endif
#endif
...
void VirtualKeyboard(bool pressed) {
    if (pressed)
        return;

    // Run virtual keyboard
#if SDL_VERSION_ATLEAST(2, 0, 0)
    VKEYBD_Run(pdc_window, pdc_screen->format);
#else
...
//extern void consoleDebugInit(debugDevice device);
